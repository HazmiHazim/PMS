    ...
    <div class="relative isolate overflow-hidden bg-gray-900 py-24 sm:py-32">
        ...
        <div class="mx-auto max-w-7xl px-6 lg:px-8">
            <div class="mx-auto max-w-2xl lg:mx-0">
                <h2 class="text-4xl font-bold tracking-tight text-white sm:text-6xl">PETAKOM</h2>
                ...
                <li>
                    <div class="flex items-center gap-x-6">
                        <img class="h-16 w-16 rounded-full"
                            src="{{ asset('images/public/leader.jpg') }}"
                            alt="">
                        <div>
                            <h3 class="text-base font-semibold leading-7 tracking-tight text-gray-900">Iqbal Emy</h3>
            ...
            <figure class="mt-10">
                ...
                <figcaption class="mt-10">
                    ...
                    <div class="mt-4 flex items-center justify-center space-x-3 text-base">
                        <div class="font-semibold text-gray-900">Iqbal Emy</div>
