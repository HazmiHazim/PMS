...
@section('title', 'Official Announcement')
...
@section('content')
    ...
    <div class="relative flex-col p-12 h-full w-full">
        ...
        <div class="flex justify-between mb-5">
            <h1 class="text-2xl font-bold text-gray-700 px-6 md:px-0 mr-5">Official Bulletin Board</h1>
                                        ...
                                        @if (now() < $news->expired_at)
                                            <tr class="border-b dark:border-neutral-500">
                                                ...
                                                @if (Auth()->user()->role === 'coordinator')
                                                    <td class="whitespace-nowrap py-4">
                                                        <button data-modal-target="delete-modal-{{ $news->bulletin_id }}"
                                                            data-modal-toggle="delete-modal-{{ $news->bulletin_id }}"
                                                            class="font-medium text-red-600 dark:text-red-500 hover:underline"
                                                            type="button">
                                                            Delete
                                                        </button>
                                                        <div id="delete-modal-{{ $news->bulletin_id }}" tabindex="-1"
                                                            ...
                                                            <div class="relative p-4 w-full max-w-md max-h-full">
                                                                <div
                                                                    ...
                                                                    <button type="button"
                                                                        ...
                                                                        data-modal-hide="delete-modal-{{ $news->bulletin_id }}">
