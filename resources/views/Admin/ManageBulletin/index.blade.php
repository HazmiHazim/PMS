        ...
        <div class="flex justify-between mb-5">
            ...
            <div class="flex gap-3">
                @if (Auth()->user()->role === 'coordinator')
                    <a href="#"
                        class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">Approve
                        Announcement</a>
                @endif
                            ...
                            <tbody>
                                <tr class="border-b dark:border-neutral-500">
                                    ...
                                    <td class="whitespace-nowrap px-6 py-4">Lorem ipsum dolor sit amet, consectetur
                                        adipiscing elit. Aenean consequat tristique odio, et tincidunt mauris cursus a. Duis
