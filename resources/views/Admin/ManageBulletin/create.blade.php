...
@section('content')
    ...
    <div class="relative flex-col p-12 h-full w-full">
        ...
        <form action="{{ route('create-bulletin') }}" method="POST">
            ...
            <div class="flex flex-wrap -mx-3 mb-6">
                ...
                <div class="w-full">
                    ...
                    <input
                        ...
                        type="text" placeholder="Penangguhan Kelas Sempena Ketibaan Yang di-Pertuan Agong" name="title"
                        value="">
                ...
                <div class="w-full">
                    ...
                    <input
                        class="mt-2 mb-5 border-2 border-gray-200 px-3 py-2 block w-full rounded-lg text-base text-gray-900 focus:outline-none focus:border-indigo-500"
                        type="text" placeholder="https://fk.ump.edu.my/index.php/ms/others/staff-student/petakom"
                ...
                <div class="w-full">
                    ...
                    <input
                        class="mt-2 mb-5 border-2 border-gray-200 px-3 py-2 block w-full rounded-lg text-base text-gray-900 focus:outline-none focus:border-indigo-500"
                        type="text" placeholder="No. of Days" name="duration" value="">
                ...
                <div class="flex justify-end mt-10 h-full w-full">
                    ...
                    <button type="submit"
                        class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800 ml-3">Create
                        Announcement</button>
                </div>
